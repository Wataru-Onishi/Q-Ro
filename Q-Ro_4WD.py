...
try:
    ...
    while True:
        ...
        # 各モーターに速度を指令
        # 左側 (ID 1, 3)
        packetHandler.write4ByteTxRx(portHandler, 1, ADDR_GOAL_VELOCITY, velocity_left * MOTOR_DIRECTION[3])
        packetHandler.write4ByteTxRx(portHandler, 3, ADDR_GOAL_VELOCITY, velocity_left * MOTOR_DIRECTION[4])

        # 右側 (ID 2, 4)
        packetHandler.write4ByteTxRx(portHandler, 2, ADDR_GOAL_VELOCITY, velocity_right * MOTOR_DIRECTION[1])
        packetHandler.write4ByteTxRx(portHandler, 4, ADDR_GOAL_VELOCITY, velocity_right * MOTOR_DIRECTION[2])
